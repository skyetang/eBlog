		...
		<div class="header">
			...
			<ul id="nav" class="nav">
				...
				<li id="<?php echo ($val["id"]); ?>">
					<a href="<?php echo U('Category/Index',array('cate'=>$val['catealias']));?>">
						...
						<div id="sub_<?php echo ($val["id"]); ?>" class="category clearfix">
						    <div class="category_left">
						    	<dl class="category_ul">
						    		<?php foreach($val[child] as $k => $v): ?>
									 <a href="<?php echo U('Category/Index',array('cate'=>$v['catealias']));?>">
							...
							<div class="category_right">
								...
								<h5><a href="<?php echo U('Article/Index',array('post'=>$vv['id']));?>"><?php echo ($vv["title"]); ?></a></h5>
								<?php endforeach ?>
							</div>
					    </div>
				</li>
			...
			<div class="content_left">
				...
				<div class="article_list">				
					<div class="article_main">
	                	<h2><a title="<?php echo ($val["title"]); ?>" href="<?php echo U('Article/Index/',array('post'=>$val['id']));?>"><?php echo ($val["title"]); ?></a></h2>
	                	<small>发表日期：<?php echo ($val["time"]); ?>&nbsp;|&nbsp;作者：<?php echo ($val["author"]); ?>&nbsp;|&nbsp;浏览：<?php echo ($val["view"]); ?></small>
	                	<p><?php $str =htmlspecialchars_decode($val['content']); $data=strip_tags($str); $str2 =mb_substr($data,0,180,'utf-8'); echo $str2; ?>......<br /><a href="<?php echo U('Article/Index/',array('post'=>$val['id']));?>">[阅读全文]</a></p>
			...
			<div class="content_right">
				...
				<div class="tags">
					...
					<h4>最近发表:</h4>
						...
						<li><a href="<?php echo U('Article/Index',array('post'=>$vv['id']));?>" title="<?php echo ($vv["title"]); ?>">
							<?php
