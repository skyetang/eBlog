<?php if (!defined('THINK_PATH')) exit();?>  <!--  <div id="dialog" class="dialog">-->
    	...
    	<div class="dialog_window">
    		 ...
    		 <div class="dia_cont">
    		 	...
    		 	<input type="text" value="<?php echo ($data["username"]); ?>" name="username" id="username"/>
    		 ...
    		 <div class="dia_bot">
    		 	...
    		 	<button id="dia_sure" class="dia_button" onclick="$.action('<?php echo U('Admin/Manager/doEdit');?>',this)"><span class="icon-checkmark"></span>确定</button>
    		 </div>
    	</div>
    	</form>
  <!--  </div>-->